...
public:
    ...
    void CopyDepth(const BYTE* source, UINT size, BOOL nearMode, DEPTH_TREATMENT treatment, DWORD width, DWORD height, RGBQUAD* pQuad, LONG *pMappedCoord, RGBQUAD* pEndAddr);
